<template>
  ...
  <!-- 上传操作禁用时 -->
  <div v-if="disabled" class="upload-file is-disabled">
...
const props = defineProps({
  ...
  fileType: propTypes.array.def(['doc', 'xls', 'ppt', 'txt', 'pdf', 'jpg', 'jpeg', 'png', 'gif']), // 文件类型, 例如['png', 'jpg', 'jpeg']
...
const handleFileSuccess: UploadProps['onSuccess'] = (res: any): void => {
  ...
  uploadList.value.push({ name: fileList.value[index].name, url: res.data })
...
const emitUpdateModelValue = () => {
  ...
  //   result = result.join(',')
  // }
  const result = JSON.stringify(fileList.value)
