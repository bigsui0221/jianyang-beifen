...
<template>
  <div class="wange-editor border-1 border-solid border-[var(--tags-view-border-color)] z-10">
    <!-- 工具栏 -->
...
.wange-editor {
  --tags-view-border-color: var(--el-input-border-color, var(--el-border-color));
