  ...
  const renderTopLeft = () => {
    return (
      <>
        ...
        <div class="absolute left-0 top-[var(--top-tool-height)] h-[calc(100%-var(--top-tool-height))] w-full flex">
          <Menu class={[
              'relative !h-full p-16px pt-8px',
              {
                '!p-0 !pt-8px': collapse.value
              }
            ]}></Menu>
          <div
          id="layout-main"
  ...
  const renderTop = () => {
    return (
      <>
        ...
        <div id="layout-main" class={[`${prefixCls}-content`, 'w-full h-[calc(100%-var(--top-tool-height))]']}>
          <ElScrollbar
            v-loading={pageLoading.value}
            class={[
              `${prefixCls}-content-scrollbar`,
  ...
  const renderCutMenu = () => {
    return (
      <>
        ...
        <div class="absolute left-0 top-[var(--top-tool-height)] h-[calc(100%-var(--logo-height))] w-full flex">
          <TabMenu></TabMenu>
          <div
          id="layout-main"
            class={[
