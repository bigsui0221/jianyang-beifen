<template>
  ...
  >
    ...
    <el-form
      ...
      label-width="68px"
    >
      <el-form-item label="应用名称" prop="applicationRealCode">
        <el-select
          v-model="queryParams.applicationRealCode"
          clearable
          filterable
          placeholder="请选择应用"
          class="!w-240px"
  ...
  >
    ...
    <el-table :height="tbMaxHeight" v-loading="loading" :data="list">
      ...
      <el-table-column label="描述" align="center" prop="applicationName" />
    </el-table>
    <!-- 分页组件 -->
    <Pagination
      margin="0"
...
const applicationList = ref<ApplicationApi.ApplicationVO[]>([]) // 应用列表
...
onMounted(async () => {
  ...
  // 获得应用列表
  applicationList.value = await ApplicationApi.getApplicationList()
  getList()
})
</script>
