<template>
      ...
      <el-table-column label="操作" align="center" width="224" fixed="right">
        <template #default="scope">
          <div class="flex items-center justify-center">
            ...
            <el-button type="primary" link @click="handleResetPwd(scope.row)"> 执行 </el-button>
            <el-button type="primary" link @click="handleResetPwd(scope.row)"> 日志 </el-button>
  ...
  <!-- 添加或修改用户对话框 -->
  <TaskManageForm ref="formRef" @success="getList" />
</template>
...
import TaskManageForm from './TaskManageForm.vue'
